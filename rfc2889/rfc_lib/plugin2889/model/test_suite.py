...
from plugin2889.dataset import IPv4Address, IPv6Address, MacAddress, IPv4Prefix, IPv6Prefix
...
class IPV6AddressProperties(BaseModel, arbitrary_types_allowed=True):
    ...
    routing_prefix: IPv6Prefix | int = IPv6Prefix(64)
    public_address: IPv6Address | str
    public_routing_prefix: IPv6Prefix | int = IPv6Prefix(64)
...
class IPV4AddressProperties(BaseModel, arbitrary_types_allowed=True):
    ...
    routing_prefix: IPv4Prefix | int = IPv4Prefix(24)
    public_address: IPv4Address | str
    public_routing_prefix: IPv4Prefix | int = IPv4Prefix(24)
